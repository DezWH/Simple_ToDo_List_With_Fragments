...
public class AddToDoItemFragment extends Fragment {
    ...
    //Nothing happens here except createing a new Fragment
    //but this is nice in case we did need to send any data to this Frament
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof NewItemCreatedListener) {
            ...
            throw new RuntimeException(context.toString() + "must implement NewItemCreatedListner");
        }
    }
