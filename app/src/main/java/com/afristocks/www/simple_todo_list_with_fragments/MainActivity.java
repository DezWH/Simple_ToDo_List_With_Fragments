...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState ==null) {
            ...
            //Create new ArrayList, and add Add and List Fragemtns.
            Log.d(TAG, "onCreate has no instance state. Set up up ArrayList, add List Fragment and Add fragment");
            ...
            ft.commit();
                ...
                //There is saved intance state,m so that app has already run,
    ...
    @Override
        ...
        @Override
            ...
            //Cteate a new Detail fragment. Add it to the Activity
            ...
            //fragment, it will revert this transaction  - Activity will go back to the Add list Fragements
